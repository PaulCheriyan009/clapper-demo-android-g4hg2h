...
export class AppComponent {
 ...
 customData= 
  {
			version:"1.0.0",
			cxAuthenticationDataToken:"58a5d56f-9cf0-4063-bb7c-87ebdf8f6d2a",
			cxClientInfo:{
						CxDeviceId:"cc3755f4-f50a-39d1-8a0b-e7a0b01b0b5f",
						DeviceType:"Browser",
						DrmClientType:"Widevine-HTML5",
						DrmClientVersion:"1.0.0"
					}
  ...
  var player = new Clappr.Player(
    {
      ...
      source:'http://172.11.11.31/chome_02/harvesttv/index.m3u8',//chome
      ...
      shakaOnBeforeLoad: function(shaka_player) {
          ...
          var licenseServer = 'https://viewway.ap-south-1.conax.cloud:443/widevine/license'
